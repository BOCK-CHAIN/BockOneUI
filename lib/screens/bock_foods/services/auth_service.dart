  ...
  static Future<Map<String, dynamic>> login({
    ...
    try {
      ...
      if (foodsBaseUrl != null && foodsBaseUrl.trim().isNotEmpty) {
        final resolvedFoodsBaseUrl = await BackendUrlResolver.resolve(
          configuredBaseUrl: foodsBaseUrl,
          defaultPort: 3000,
        );
  ...
  static Future<Map<String, dynamic>> _loginToFoodsServer({
    ...
    if (response.body.isNotEmpty) {
      try {
        ...
        data = {
          'message': 'Unexpected response from $uri',
        };
      }
    }
