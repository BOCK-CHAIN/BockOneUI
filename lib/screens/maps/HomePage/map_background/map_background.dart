...
class _MapBackgroundState extends State<MapBackground> {
  ...
  String _resolveTileTemplate(String? base) {
    if (base == null || base.trim().isEmpty) {
      return 'http://localhost:8081/styles/basic-preview/{z}/{x}/{y}.png?key=myfirstkey';
    }
    ...
    return Stack(
      children: [
        FlutterMap(
          ...
          children: [
            TileLayer(
              urlTemplate: _resolveTileTemplate(mapurl),
