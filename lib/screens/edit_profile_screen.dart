...
class EditProfileScreenState extends State<EditProfileScreen> with TickerProviderStateMixin {
  ...
  Future<void> _saveChanges() async {
    ...
    if (_enteredFirstName != _originalData['firstName']) {
      updatedFields['firstName'] = _enteredFirstName;
    }
    if (_enteredLastName != _originalData['lastName']) {
      updatedFields['lastName'] = _enteredLastName;
    }
    if (_enteredUserName != _originalData['username']) {
      updatedFields['username'] = _enteredUserName;
    }
    if (_enteredPassword != _originalData['password']) {
      updatedFields['password'] = _enteredPassword;
    }
    if (_enteredGender != _originalData['gender']) {
      updatedFields['gender'] = _enteredGender;
    }
    if (_dateController.text != _originalData['DOB']) {
      updatedFields['DOB'] = _dateController.text;
    }
