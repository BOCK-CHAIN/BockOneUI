...
class Candidate extends Equatable {
  ...
  factory Candidate.fromJson(Map<String, dynamic> json) {
    ...
    final candidateId = (json['id'] ?? '').toString();
    final ipfsProfile = (json['ipfsProfileHash'] ?? '').toString();

    return Candidate(
      id: candidateId,
      name: (json['name'] ?? (ipfsProfile.isNotEmpty ? ipfsProfile : 'Candidate $candidateId'))
          .toString(),
      ...
      electionIds: List<String>.from(
        (json['electionIds'] as List?) ??
            (json['electionId'] != null ? [json['electionId']] : []),
      ),
      ...
      updatedAt: _parseDateOrNull(json['updatedAt']) ??
          _parseUnixDateOrNull(json['timestamp']) ??
          now,
      userId: (json['userId'] ?? json['publicKey'] ?? 'system').toString(),
