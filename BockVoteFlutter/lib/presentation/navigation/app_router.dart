      ...
      routes: [
        ...
        GoRoute(
          ...
          builder: (context, state) =>
              const ElectionsScreen(), // Will be replaced with ElectionDetailScreen in future
        ),
        ...
        GoRoute(
          ...
          name: 'result-detail',
          builder: (context, state) =>
              ResultDetailScreen(electionId: state.pathParameters['id'] ?? ''),
        ),
        ...
        GoRoute(
          ...
          builder: (context, state) =>
              const NotFoundScreen(), // Will be implemented in future
        ),
        ...
        GoRoute(
          ...
          builder: (context, state) => Scaffold(
            body: Center(
              child: Text(
                'Edit Election ${state.pathParameters['id']} - Coming Soon',
              ),
            ),
          ),
        ),
